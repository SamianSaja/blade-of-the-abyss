...
# ==================== Setter ====================
func set_support_status(support_status):
	support_status_bar = support_status
...
func update_support_status():
	if support_status_bar and support_status_bar.has_method("set_status"):
		support_status_bar.set_status(
			hp, max_hp,
			mp, max_mp,
			tp, max_tp,
			speed,
